...
class JFormFieldCHtml extends CFormField
{
	...
	public function onRenderList($record, $type, $section)
	{
		...
		{
			$value = HTMLFormatHelper::substrHTML($value, $this->params->get('params.intro'));
		}
		...
		{
			$value .= '<p>'.JHtml::link($record->url, JText::_($this->params->get('params.readmore_lbl','H_READMORE')), array('class' => 'read-more')).'</p>';
		}
