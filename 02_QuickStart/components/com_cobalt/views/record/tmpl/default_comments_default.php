...
<div style="margin-left: <?php echo $params->get('tmpl_params.comments_indent') * ($this->comment->level - 1)?>px;" id="comment<?php echo $this->comment->id?>-container" class="">
	<div class="row-fluid">
		<div class="tt-comm-avatar span<?php echo $this->comment->level > 1 ? 1 : 2; ?>">
		...
		<div class="tt-comm-body span<?php echo $this->comment->level > 1 ? 11 : 10; ?> has-context<?php echo  $this->comment->private ? ' private' : null; echo  !$this->comment->published ? ' published' : null?>">
			...
			<div class="pull-left tt-comm-head" style="height: 25px;">
				...
				<?php if($params->get('tmpl_core.comments_username')):?>
					<small><?php echo JText::sprintf('CWRITTENBY', CCommunityHelper::getName($this->comment->user_id, $this->section)); ?></small>
				<?php endif;?>
