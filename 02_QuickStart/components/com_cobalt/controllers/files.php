...
class CobaltControllerFiles extends JControllerAdmin
{
	...
	public function download()
	{
		...
		elseif(@ereg('MSIE ([0-9].[0-9]{1,2})', $browser))
		{
			$browser = 'IE';
		}
		elseif(@ereg('OmniWeb/([0-9].[0-9]{1,2})', $browser))
		{
			$browser = 'OMNIWEB';
		}
		elseif(@ereg('(Konqueror/)(.*)', $browser))
		{
			$browser = 'KONQUEROR';
		}
		elseif(@ereg('Mozilla/([0-9].[0-9]{1,2})', $browser))
		{
			$browser = 'MOZILLA';
		}
		else
	...
	public function show()
	{
		...
		else
		{
			...
			$path       = JPATH_CACHE . DIRECTORY_SEPARATOR . 'cobalt_thumbs' . DIRECTORY_SEPARATOR . $folder . DIRECTORY_SEPARATOR;
