...
?>
<span class="comment-date"><?php echo JCommentsText::formatDate($comment->date,  'h : i A, F d, Y'); ?></span>
<span class="comments-buttons">
<?php
					if ($this->getVar('button-reply') == 1) {
?>
<a href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>); return false;"><?php echo JText::_('BUTTON_REPLY'); ?><i class="uk-icon-caret-right"></i></a>
<?php
