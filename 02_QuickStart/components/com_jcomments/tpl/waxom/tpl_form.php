...
?>
<h4><?php echo JText::_('Leave a Comment.'); ?></h4>
<?php
...
<p>
	<span>
		<input id="comments-form-name" placeholder='<?php echo JText::_('Your Name'); ?>' type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<p>
	<span>
		<input id="comments-form-email" placeholder='<?php echo JText::_('Email Address'); ?>' type="text" name="email" value="" size="22" tabindex="2" />
...
<p>
	<span>
		<input id="comments-form-homepage" placeholder='<?php echo JText::_('Web Site'); ?>' type="text" name="homepage" value="" size="22" tabindex="3" />
...
<p>
	<span>
		<textarea placeholder='<?php echo JText::_('Write Comment'); ?>' id="comments-form-comment" name="comment" cols="65" rows="8" tabindex="5"></textarea>
	</span>
</p>
<?php
...
<div id="comments-form-buttons">
    <div id="comments-form-send"><a class="btn brown large" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a></div>
	<div id="comments-form-cancel" style="display:none;"><a class="btn brown large" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a></div>
