...
class JHTMLCobalt
{
	...
	public static function fieldtypes($select = false)
	{
		...
		JModelLegacy::addIncludePath(JPATH_ROOT. DIRECTORY_SEPARATOR .'administrator'. DIRECTORY_SEPARATOR .'components'. DIRECTORY_SEPARATOR .'com_cobalt'. DIRECTORY_SEPARATOR .'models');
