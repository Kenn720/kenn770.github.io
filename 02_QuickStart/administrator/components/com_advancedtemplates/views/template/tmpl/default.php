...
<div class="row-fluid">
	...
	<div class="span9">
		<?php if ($this->type == 'home'): ?>
			<form action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
		...
		<?php if ($this->type == 'font'): ?>
			<div class="font-preview">
				<form
					action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
					method="post" name="adminForm" id="adminForm" class="form-horizontal">
					<fieldset class="adminform">
						<p class="lead">H1</p>
						...
						<p class="lead">H6</p> <h6>Quickly gaze at Joomla! views from HTML, CSS, JavaScript and
							XML </h6>

						<p class="lead">Bold</p><b>Quickly gaze at Joomla! views from HTML, CSS, JavaScript and XML </b>

						<p class="lead">Italics</p><i>Quickly gaze at Joomla! views from HTML, CSS, JavaScript and
							XML </i>
	...
	<div class="span4">
		...
		<ul class="nav nav-list">
			<?php foreach ($this->overridesList['modules'] as $module): ?>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&task=template.overrides&folder=' . $module->path . '&id=' . $input->getInt('id') . '&file=' . $this->file); ?>">
				...
				<li class="component-folder">
					...
					<ul class="nav nav-list">
						<?php foreach ($value as $view): ?>
							<li>
								<a class="component-file-url"
								   href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&task=template.overrides&folder=' . $view->path . '&id=' . $input->getInt('id') . '&file=' . $this->file); ?>">
	...
	<div class="span4">
		...
		<ul class="nav nav-list">
			<?php foreach ($this->overridesList['layouts'] as $layout): ?>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&view=template&task=template.overrides&folder=' . $layout->path . '&id=' . $input->getInt('id') . '&file=' . $this->file); ?>">
...
<form action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.copy&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			...
			<div id="template-manager-css" class="form-horizontal">
				<div class="control-group">
					<label for="new_name" class="control-label hasTooltip"
					       title="<?php echo JHtml::tooltipText('COM_TEMPLATES_TEMPLATE_NEW_NAME_DESC'); ?>"><?php echo JText::_('COM_TEMPLATES_TEMPLATE_NEW_NAME_LABEL') ?></label>
...
<?php if ($this->type != 'home'): ?>
	<form
		action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.renameFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
		method="post">
		<div id="renameModal" class="modal hide fade">
			...
			<div class="modal-body">
				<div id="template-manager-css" class="form-horizontal">
					<div class="control-group">
						<label for="new_name" class="control-label hasTooltip"
						       title="<?php echo JHtml::tooltipText(JText::_('COM_TEMPLATES_NEW_FILE_NAME')); ?>"><?php echo JText::_('COM_TEMPLATES_NEW_FILE_NAME') ?></label>
...
<?php if ($this->type != 'home'): ?>
	<div id="deleteModal" class="modal hide fade">
		...
		<div class="modal-footer">
			<a href="#" class="btn" data-dismiss="modal"><?php echo JText::_('COM_TEMPLATES_TEMPLATE_CLOSE'); ?></a>
			<a href="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.delete&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			   class="btn btn-danger"><?php echo JText::_('COM_TEMPLATES_BUTTON_DELETE'); ?></a>
		</div>
	</div>
<?php endif; ?>
...
<div id="fileModal" class="modal hide fade">
	...
	<div class="modal-body">
		...
		<div class="column">
			<form method="post"
			      action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.createFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			      class="well">
				<fieldset>
			...
			<form method="post"
			      action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.uploadFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			...
			<?php if ($this->type != 'home'): ?>
				<form method="post"
				      action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.copyFile&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
				      class="well" enctype="multipart/form-data">
					<fieldset>
						<input type="hidden" class="address" name="address">
						...
						<div class="control-group">
							<label for="new_name" class="control-label hasTooltip"
							       title="<?php echo JHtml::tooltipText('COM_TEMPLATES_FILE_NEW_NAME_DESC'); ?>"><?php echo JText::_('COM_TEMPLATES_FILE_NEW_NAME_LABEL') ?></label>
...
<div id="folderModal" class="modal hide fade">
	...
	<div class="modal-body">
		...
		<div class="column">
			<form method="post"
			      action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.createFolder&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
			      class="well">
				<fieldset>
	...
	<div class="modal-footer">
		<form id="deleteFolder" method="post"
		      action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.deleteFolder&id=' . $input->getInt('id') . '&file=' . $this->file); ?>">
			<fieldset>
				<a href="#" class="btn" data-dismiss="modal"><?php echo JText::_('COM_TEMPLATES_TEMPLATE_CLOSE'); ?></a>
				<input type="hidden" class="address" name="address">
...
<?php if ($this->type != 'home'): ?>
	<form
		action="<?php echo JRoute::_('index.php?option=com_advancedtemplates&task=template.resizeImage&id=' . $input->getInt('id') . '&file=' . $this->file); ?>"
		method="post">
				...
				<div id="template-manager-css" class="form-horizontal">
					<div class="control-group">
						<label for="height" class="control-label hasTooltip"
						       title="<?php echo JHtml::tooltipText('COM_TEMPLATES_IMAGE_HEIGHT'); ?>"><?php echo JText::_('COM_TEMPLATES_IMAGE_HEIGHT') ?></label>

						<div class="controls">
							<input class="input-xlarge" type="number" name="height" placeholder="<?php echo $this->image['height']; ?> px" required>
						</div>
						<br>
						<label for="width" class="control-label hasTooltip"
						       title="<?php echo JHtml::tooltipText('COM_TEMPLATES_IMAGE_WIDTH'); ?>"><?php echo JText::_('COM_TEMPLATES_IMAGE_WIDTH') ?></label>
...
<?php if ($this->config->show_switch) : ?>
	<div style="text-align:right">
		<a href="<?php echo JRoute::_('index.php?option=com_templates&force=1&task=style.edit&id=' . (int) $this->state->get('extension.id')); ?>"><?php echo JText::_('ATP_SWITCH_TO_CORE'); ?></a>
	</div>
<?php endif; ?>
