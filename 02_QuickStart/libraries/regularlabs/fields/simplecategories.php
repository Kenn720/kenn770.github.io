...
class JFormFieldRL_SimpleCategories extends RLFormField
{
	...
	protected function getInput()
	{
		...
		RLFunctions::script('regularlabs/script.min.js', '16.5.3297');
		RLFunctions::script('regularlabs/toggler.min.js', '16.5.3297');
		...
		RLFunctions::script('regularlabs/simplecategories.min.js', '16.5.3297');
