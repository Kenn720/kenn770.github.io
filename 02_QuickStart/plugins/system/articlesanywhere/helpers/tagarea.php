...
class PlgSystemArticlesAnywhereHelperTagArea
{
	public function _(&$string, $area_type = '')
	{
		if (!$string || !$area_type)
		{
			return;
	...
	public function getByType(&$string, $area_type = '')
	{
		if (!$string || !$area_type)
		{
			return array();
		...
		$this->tagByType($string, $area_type);
	...
	private function tagByType(&$string, $area_type)
	{
		switch ($area_type)
		{
			case 'component':
